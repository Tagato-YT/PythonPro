...
facts_list = [
            ...
            "Elon Musk también aboga por la regulación de las redes sociales y la protección de los datos personales de los usuarios.Afirma que las redes sociales recopilan una enorme cantidad de información sobre nosotros, que luego puede utilizarse para manipular nuestrospensamientos y comportamientos",
...
def hello_world():
    return  """
        <h2>Hola! En esta pagina puedes aprender muchas cosas sobre dependencia tecnologica.</h2>
...
def password():
    ...
    return f"<h1>Contraseña generada: {contraseña}</h1>"
